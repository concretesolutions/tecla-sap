...
export default function TipsJavascriptOptimization() {
  return (
    <>
     ...
     <Head>
        <title>
          17 dicas de otimização de JS para conhecer em 2021
        </title>
      </Head>
    </header>
    <div className={styles.container}>
      <main className={styles.posts}>
        <Image src='/logo_high.png' 
        ...
        <article className={styles.article}>
          <h1 className={styles.post}>17 dicas de otimização de Javascript para conhecer em 2021</h1>
          <code>
            Original:
          ...
          <p>Podemos armazenar valores em um array e podemos usar o método includes para fazer a verificação da condição:</p>
          <pre className={styles.pre}>
            <code>
            //formato mais longo<br />
            if (x === 'abc' || x === 'def' || x === 'ghi' || x ==='jkl') { <br />

            }<br />
            <br />
            //formato mais curto<br />
